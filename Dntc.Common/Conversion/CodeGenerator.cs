...
public class CodeGenerator
{
    ...
    public async Task GenerateStruct(DotNetDefinedType type, StreamWriter writer)
    {
    ...
    public async Task GenerateMethodDeclaration(DotNetDefinedMethod method, StreamWriter writer)
    {
